<%@page import="com.msit.books.Publishers"%>
...
document.getElementById("randImage").src = "image.jsp?"+Math.random(); 
    ...
    <div id="action_area">
        ...
        <form action="do_login.jsp" method="post" class="member_form" onsubmit="return a()">
			...
			<!-- 	<p><label>验证码</label>
				<input	name="rand" type="text" size="7" onblur="number()" /> 
				<a href="javascript:loadimage();"> <img alt="code..."
						name="randImage" id="randImage" src="image.jsp" width="60"
						height="20" border="1" align="absmiddle"> </a> &nbsp; <a
					href="javascript:loadimage();"><font class=pt95>看不清点我</font>
				</a> </p>
				<p>	<div class="tt" id="num">验证码不许为空</div></p> -->
				
            <p class="form_sub"><input type="checkbox" name=""  checked="checked" />  在此计算机上保留我的密码</p>
            <p class="form_sub"><input type="submit" value="登录" class="opt_sub" /><a href="#">忘记密码？</a></p>
