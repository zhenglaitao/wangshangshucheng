<%@page import="com.msit.books.readercomments"%>
...
function out()
{
	...
	images1.width = Math.floor(w*0.8);
        ...
        <dl class="book_intro">
        	<dt>编辑推荐</dt>
            <dd> <%=n.getAurhorDescription() %>  </dd>
        </dl>
        
        <dl class="book_intro">
        	<dt>内容简介</dt>
            <dd><%=n.getContentDescription()%>   </dd>
        </dl>
        <c:set var="s1" value="<%=n.getToc()%>" />
        <dl class="book_intro">
        	<dt>目录</dt>
            <dd>${fn:substring(s1,0,150)}......</dd>
        ...
        <div class="comm_answer">
                ...
                <div class="total_comm">
                    ...
                    <div class="total_body">
                        ...
                        <div class="write_comm">
                            <a id="reviewTipa"  href="bookde.jsp?nid=<%=nid %>"><img src="Images/button_write_comm.gif" border="0" title="写评论" /></a>
                        </div>
            ...
            <jsp:useBean id="pinglun" class="book.pinglun"/>
            <%
				List<readercomments> reader =pinglun.selectpinglun(nid);
				%>
            ...
            <%
						...
						%>
                <h3>
                    <img src="Images/label_1.gif"  title="精彩评论" /><%=reader.get(j).getTitle() %>
                    <span>发表于: <%=reader.get(j).getRdate() %> </span>
                </h3>
               <%=reader.get(j).getRcomment() %>
          <%}
				 }%>
            </div>
            <!--the one reviews end-->
