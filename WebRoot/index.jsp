...
<!-- 根据出版社 查找 -->
 <div id="search">
    ...
    <!--中间-->
    <div id="content">
    	<div id="magic"><img src="Images/a_b_02.jpg" alt="幻灯图片" width="480" height="200" id="img" style="z-index: 2"/>
      ...
      <li> <a href="JavaScript:chaImg(1)">●</a>
        ...
        <li ><a href='bookdetail.jsp?nid=${ns.id}'>  <div class="scale"> 
        <img src="Images/BookCovers/${ns.isbn}.jpg" onerror="this.src='Images/default.jpg'" alt="" width="100" height="300"/> 
      </div>
       ...
       <br/>
        ...
        <c:if test="${pageIndex==1}">
         ...
         <a href="index.jsp?pageIndex=<%=total_page%>">末页</a> 
        </c:if>
